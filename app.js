 ...
 *
 * This file represents the main entry point of the Vanthasix application.
...
if (cluster.isMaster) {
  const numCPUs = 8;
  console.log(chalk.gray('Starting workers on Vanthasix 14 (VNTHSY)'))
  ...
  app.use((req, res, next) => {
    res.setHeader("X-Powered-By", "14th Gen Vanthasix (VNTHSY)");
    next();
  });
